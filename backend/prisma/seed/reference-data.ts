...
export const COUNTRIES: readonly CountryDefinition[] = [
  { code: 'US', name: 'United States', defaultCurrencyCode: 'USD', payScaleBasisPoints: 10000, headcountWeight: 22 },
  { code: 'IN', name: 'India', defaultCurrencyCode: 'INR', payScaleBasisPoints: 3200, headcountWeight: 18 },
  { code: 'GB', name: 'United Kingdom', defaultCurrencyCode: 'GBP', payScaleBasisPoints: 9200, headcountWeight: 10 },
  { code: 'DE', name: 'Germany', defaultCurrencyCode: 'EUR', payScaleBasisPoints: 9000, headcountWeight: 8 },
  { code: 'CA', name: 'Canada', defaultCurrencyCode: 'CAD', payScaleBasisPoints: 9000, headcountWeight: 5 },
  { code: 'FR', name: 'France', defaultCurrencyCode: 'EUR', payScaleBasisPoints: 8700, headcountWeight: 5 },
  { code: 'AU', name: 'Australia', defaultCurrencyCode: 'AUD', payScaleBasisPoints: 9600, headcountWeight: 4 },
  { code: 'BR', name: 'Brazil', defaultCurrencyCode: 'BRL', payScaleBasisPoints: 4200, headcountWeight: 4 },
  { code: 'NL', name: 'Netherlands', defaultCurrencyCode: 'EUR', payScaleBasisPoints: 9300, headcountWeight: 3 },
  { code: 'SG', name: 'Singapore', defaultCurrencyCode: 'SGD', payScaleBasisPoints: 9800, headcountWeight: 3 },
  { code: 'JP', name: 'Japan', defaultCurrencyCode: 'JPY', payScaleBasisPoints: 7800, headcountWeight: 3 },
  { code: 'MX', name: 'Mexico', defaultCurrencyCode: 'MXN', payScaleBasisPoints: 3800, headcountWeight: 3 },
  { code: 'ES', name: 'Spain', defaultCurrencyCode: 'EUR', payScaleBasisPoints: 7200, headcountWeight: 2 },
  { code: 'IT', name: 'Italy', defaultCurrencyCode: 'EUR', payScaleBasisPoints: 7500, headcountWeight: 2 },
  { code: 'IE', name: 'Ireland', defaultCurrencyCode: 'EUR', payScaleBasisPoints: 9500, headcountWeight: 2 },
  { code: 'SE', name: 'Sweden', defaultCurrencyCode: 'SEK', payScaleBasisPoints: 8800, headcountWeight: 2 },
  { code: 'CH', name: 'Switzerland', defaultCurrencyCode: 'CHF', payScaleBasisPoints: 12000, headcountWeight: 2 },
  { code: 'PL', name: 'Poland', defaultCurrencyCode: 'PLN', payScaleBasisPoints: 5200, headcountWeight: 2 },
  { code: 'ZA', name: 'South Africa', defaultCurrencyCode: 'ZAR', payScaleBasisPoints: 3600, headcountWeight: 1 },
  { code: 'AE', name: 'United Arab Emirates', defaultCurrencyCode: 'AED', payScaleBasisPoints: 8200, headcountWeight: 1 },
];
